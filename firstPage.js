btn.addEventListener('click', () => {
  // create curtain first (immediate)
  ...
  // curtain animation start immediately
  left.classList.add("open-left");
  right.classList.add("open-right");

  // burst hearts run simultaneously (no waiting)
  for (let i = 0; i < 45; i++) {
  ...
  // redirect AFTER curtain animation finishes
  setTimeout(() => {
    window.location.href = "page2.html";
  }, 1300); // curtain duration
});